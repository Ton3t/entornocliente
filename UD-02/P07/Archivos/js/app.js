class Fruta {
    constructor(ref, precio) {
        this.ref = ref;
        this.precio = precio;
    }
}

var aguacate = new Fruta("Aguacate", 5);
var albaricoque = new Fruta("Albaricoque", 3);
var cereza = new Fruta("Cereza", 7);
var fresas = new Fruta("Fresas", 6);
var granada = new Fruta("Granada", 5);
var lima = new Fruta("Lima", 1);
var manzana = new Fruta("Manzana", 2);
var melocoton = new Fruta("Melocoton", 3);
var naranja = new Fruta("Naranja", 4);
var pera = new Fruta("Pera", 4);
var pinya = new Fruta("Piña", 2);
var platano = new Fruta("Platano", 2);
var sandia = new Fruta("Sandia", 1);
...
function anyadirFruta() {
    ...
    if(validarDni() && cantidad != "" && zonaRef.value != "ref" && zonaPrecio.value != 0) {
        ...
        /*
        for(let i = 0; i < facturasTotal.length; i++) {
            pedido += pedido + facturasTotal[i];
        }
        */
